# How much can you expect to earn in each state?



# What are the top 3 highest earning cities in each state?
...
# How does salary change for the same listing in different locations?
